      ...
      <FadeSection className="py-16 md:py-24" style={{ background: "#112240" }}>
        <div className="max-w-5xl mx-auto px-5">
          ...
          <div className="max-w-3xl mx-auto text-center mb-10">
            ...
            <p className="text-white text-lg leading-relaxed mb-4">
              כחלק מ<strong className="text-white">תוכניות גפ״ן - תוכניות ההעשרה של משרד החינוך</strong>, העברנו את הסדנה ל-15,000 תלמידי תיכון. הפידבק היה מטורף. הבנו שאנחנו חייבים להפיץ את הבשורה ולהגיע לכל הצעירים - גם למי שלא עבר את זה דרך בית הספר.
            </p>
            <p className="text-white text-lg leading-relaxed font-medium">
              אז בנינו את הסדנה הדיגיטלית. 58 שיעורים שמזקקים שנים של ניסיון בשטח לתוך 3 שעות.
            </p>
          </div>
          ...
          <div className="flex items-center justify-center gap-8 md:gap-16 mb-12">
            {[
              { num: 15000, suffix: '+', label: 'תלמידי תיכון' },
