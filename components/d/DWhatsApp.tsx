...
export default function DWhatsApp() {
  ...
  return (
    <a
      ...
      className="fixed bottom-20 right-5 z-[60] flex items-center gap-2 group"
    >
      {/* Label */}
      <span
        className={`
          bg-[#111] text-white/80 text-sm px-3 py-1.5 rounded-full
      ...
      {/* Button */}
      <div className="w-14 h-14 rounded-full bg-[#25D366] flex items-center justify-center shadow-lg shadow-[#25D366]/25 transition-transform duration-200 group-hover:scale-110">
