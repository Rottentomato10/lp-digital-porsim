...
const STAGES = [
  {
    ...
    color: '#F5A624',
    about: 'שכר, זכויות עובד, תלוש השכר מסעיף לסעיף, מה הבנקים לא אומרים לכם על אשראי — וכיצד ריבית ואינפלציה שוחקים את הכסף בשקט.',
  },
  {
    num: '02',
    badge: 'שלב 2',
    ...
    color: '#5EEAD4',
    about: 'השקעות, שוק ההון, מניות, אג"ח ומדדים — בשפה שמבינים. קרנות סל, DCA ופיזור נכון. ואז: נדל"ן, מינוף ומשכנתא עם הראש מעל המים.',
  },
  {
    num: '03',
    badge: 'שלב 3',
    ...
    color: '#A78BFA',
    about: 'ניהול תזרים ותקציב, הטבות מס שלא כולם מכירים, קרן השתלמות, נקודות זיכוי — וצ\'ק-ליסט מנכ"ל לביצוע מיידי. בונוס: הפסיכולוגיה של כסף.',
  },
]
