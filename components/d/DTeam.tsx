      ...
      <div className="max-w-3xl mx-auto px-5">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={inView ? { opacity: 1, y: 0 } : {}}
          ...
          <p className="t-body-lg max-w-xl mx-auto mt-4">
            כבר 5 שנים אנחנו מלמדים חינוך פיננסי בבתי ספר ובמסגרות נוער ברחבי הארץ.
            עבדנו עם אלפי תלמידים — וראינו בדיוק איפה כולם נופלים.
            עכשיו, לראשונה, הבאנו את כל הידע הזה לדיגיטל.
