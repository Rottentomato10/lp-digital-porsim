...
const TEAM = [
  {
    ...
    bio: 'הדרך שלי לעולם הפיננסים התחילה מתוך הבנה פשוטה: כסף הוא שפה, ומי שלא שולט בה — נשאר מאחור. כמתכנן פיננסי (CFP) שחי את עולם ההשקעות, אני מביא ל׳פורשים כנף׳ גישה שמתמקדת בתוצאות בשטח.',
    image: null as string | null,
  },
  {
    name: 'אביתר דנגור',
    role: 'מייסד שותף · פורשים כנף',
    bio: 'בתוך הכיתות פגשתי שוב ושוב צעירים מבריקים שעומדים לצאת לעולם בלי הבנה פיננסית. עם תואר בכלכלה וניסיון בחינוך, הקמתי את ׳פורשים כנף׳ כדי לגשר על הפער ולתת לכל צעיר את הביטחון הכלכלי שמגיע לו.',
    image: null as string | null,
  },
]
