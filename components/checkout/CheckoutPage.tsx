        ...
        <div className="grid md:grid-cols-5 gap-8">
          ...
          <div className="md:col-span-3 order-2 md:order-1">
            ...
            <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer"
              className="flex items-center justify-center gap-3 w-full py-3.5 rounded-xl border border-[#25D366]/20 bg-[#25D366]/[0.06] hover:bg-[#25D366]/[0.12] transition-colors">
              ...
              <span className="text-[#25D366] font-bold text-sm">יש שאלות? דברו איתנו בווטסאפ</span>
            </a>
          </div>
