...
const FAQ_ITEMS = [
  {
    q: 'זה מרגיש לי יקר',
    a: 'בוא נשים את זה בפרספקטיבה: טעות אחת בהלוואה, ריבית שלא בדקת, או כסף שיושב בעו"ש ומאבד ערך — עולה אלפי שקלים בשנה.\nהקורס הזה עולה פחות מארוחה זוגית במסעדה — ונשאר איתך לכל החיים.',
  },
  {
  ...
  {
    q: 'אתם לא עוד קורס שמבטיח להתעשר מהר?',
  ...
  },
  {
    ...
    a: 'זה בדיוק הזמן. הפער בין מי שמתחיל בגיל 20 לבין מי שמתחיל בגיל 30 הוא לא קטן — הוא שווה מאות אלפי שקלים בזכות ריבית דריבית.\nככל שתתחיל מוקדם יותר, הזמן עובד בשבילך.',
  },
  {
    q: 'כמה זמן זה לוקח?',
  ...
  {
    q: 'צריך רקע כלשהו?',
    a: 'אפס. הקורס מתחיל מ"מה זה בכלל כסף" ובונה משם.\nאם היה לך את הידע הזה — לא היית צריך אותנו.',
  },
  {
