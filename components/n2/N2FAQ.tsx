...
const FAQ_ITEMS = [
  ...
  {
    q: 'מה מבדיל אתכם מסדנאות פיננסיות אחרות?',
    a: 'לימדנו 15,000 תלמידים בכיתות — לא מאחורי מסך. כחלק מתוכניות משרד החינוך, עם CFP מוסמך.\nאנחנו לא מבטיחים להתעשר מהר. אנחנו מלמדים אותך להבין איך כסף עובד — ומי שמבטיח לך את זה, כדאי לברוח ממנו.',
  },
  {
