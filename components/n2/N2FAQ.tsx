...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: 'הפער בין מי שמתחיל בגיל 20 לבין מי שמתחיל בגיל 30 — זה ההבדל בין דירה בגיל 35 לבין חלום על דירה בגיל 45.\nככל שתתחיל מוקדם יותר, הזמן עובד בשבילך.',
  },
  {
    q: 'כמה זמן זה לוקח?',
