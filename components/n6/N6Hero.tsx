...
export default function N6Hero() {
  ...
  return (
    <section className="relative bg-[#0F1520] overflow-hidden">
      <div className="max-w-4xl mx-auto px-5 pt-8 pb-12">
        ...
        {/* Field stats badge — classroom presence */}
        <div className="flex items-center justify-center mb-5 px-4">
          <div className="flex items-center gap-3 xs:gap-5 px-5 py-2.5 rounded-full border border-white/10 bg-white/[0.04]">
            <span className="text-white/55 text-sm font-semibold">250+ כיתות בשטח</span>
            <span className="text-white/15">·</span>
            <span className="text-white/55 text-sm font-semibold">15,000+ תלמידים</span>
            <span className="text-white/15">·</span>
            <span className="text-white/55 text-sm font-semibold">5+ שנות פעילות</span>
          </div>
        </div>

        <div className="text-center mb-8">
          <p className="text-white/35 text-sm md:text-base font-medium tracking-wide mb-4">
        ...
        <p className="text-center text-white/55 text-lg xs:text-xl md:text-2xl leading-relaxed mb-8 max-w-2xl mx-auto">
          הידע הפיננסי שהמערכת לא לימדה אותך —
          <br />מרוכז במקום אחד, בשפה פשוטה,
          <br />כדי שתוכל לקבל החלטות חכמות על הכסף שלך.
        </p>
        ...
        <motion.div
          ...
          style={{ boxShadow: '0 0 80px rgba(245,166,36,0.06)' }}>
