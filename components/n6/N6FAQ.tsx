      ...
      <AnimatePresence initial={false}>
        {open && (
          <motion.div key="a"
            ...
            <p className="text-white/55 text-lg md:text-xl leading-relaxed pb-5 whitespace-pre-line">{a}</p>
          </motion.div>
        )}
      </AnimatePresence>
    </div>
    ...
    <section ref={ref} className="py-16 md:py-24 bg-[#0F1520]">
      <div className="max-w-3xl mx-auto px-5">
        ...
        <motion.div
          ...
          className="rounded-2xl bg-[#1A2333] border border-white/7 p-6 md:p-8"
        >
