...
export default function N3Pricing() {
        ...
        <motion.div initial={{ opacity: 0, y: 24 }} animate={inView ? { opacity: 1, y: 0 } : {}}
          ...
          <div className="p-8 md:p-12">
            ...
            <div className="flex items-center justify-center gap-4 mb-8 text-center">
              <div className="p-3 rounded-xl bg-white/5 border border-white/8 flex-1">
                <p className="text-white/30 text-xs mb-1">2 ארוחות בוולט</p>
                <p className="text-white/50 text-lg font-bold">~₪390</p>
                <p className="text-white/20 text-xs">נגמרות תוך שעה</p>
              </div>
              <span className="text-white/20 text-2xl">vs</span>
              <div className="p-3 rounded-xl bg-[#F5A624]/5 border border-[#F5A624]/20 flex-1">
                <p className="text-[#F5A624]/60 text-xs mb-1">הקורס הזה</p>
                <p className="text-[#F5A624] text-lg font-bold">₪390</p>
                <p className="text-[#F5A624]/40 text-xs">חוסך ~₪2,000+ בשנה</p>
              </div>
            </div>
            ...
            <div className="p-6 md:p-8 rounded-2xl border border-[#F5A624]/25 bg-[#F5A624]/5">
              ...
              <div className="space-y-4 text-white/60 text-base md:text-lg leading-relaxed">
                <p>נסה את הקורס 7 ימים.<br />אם לא הרגשת שזה שווה את זה — תקבל החזר מלא.<br />בלי שאלות. בלי אותיות קטנות.</p>
                <p className="text-white/80 font-medium">למה אנחנו מוכנים לתת את זה?</p>
                <p>כי אנחנו כל כך בטוחים בתוכן שבנינו.<br />ראינו אלפי אנשים שעברו את הקורס — ואנחנו יודעים מה הוא עושה.<br />אם אחרי שבוע אתה לא מרגיש שהבנת דברים שלא ידעת קודם — אנחנו לא ראויים לכסף שלך.</p>
                <p className="text-[#F5A624] font-bold">הסיכון היחיד הוא לא לנסות.</p>
              </div>
            </div>
