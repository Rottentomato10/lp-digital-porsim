...
const PROBLEMS = [
  ...
  {
    icon: TrendingUp,
    title: 'השקעות מרגישות כמו שפה אחרת',
    body: 'מניות, אג"ח, S&P500, קרנות סל, ריבית דריבית — שמעת את כל המילים האלה. ראית את הפוסטים באינסטגרם.',
    detail: 'אבל אף אחד לא הסביר לך את המושגים האלו בצורה שבאמת עשתה שינוי. אז אתה עושה את הדבר הכי טבעי — כלום.',
  ...
  },
  {
    ...
    punchline: 'בלי כלים — קשה מאוד להתחיל.',
  },
  {
    icon: Clock,
    title: 'כל חודש שעובר — זה עולה לך',
    body: 'זו לא דרמה, זו מתמטיקה. ריבית דריבית עובדת גם נגדך.',
    detail: 'ההבדל בין להתחיל להשקיע 500 ₪ בחודש בגיל 22 לבין 32 — זה לא כמה אלפי שקלים. זה יכול להיות ההבדל בין חלום על דירה לבין דירה בפועל.',
