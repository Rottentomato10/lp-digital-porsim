    ...
    <section ref={ref} className="pb-16 md:pb-24 pt-8 md:pt-10 bg-[#080808]">
      <div className="max-w-3xl mx-auto px-5">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={inView ? { opacity: 1, y: 0 } : {}}
          ...
          <div>
            <h3 className="text-white font-bold text-2xl xs:text-3xl md:text-4xl mb-5">הכסף פשוט &quot;עובר דרכך&quot;</h3>
            <p className="text-white/60 text-xl md:text-2xl leading-relaxed">
              אתה עובד קשה בשביל המשכורת, אבל היא לא באמת נשארת אצלך.
              בסוף החודש אתה מסתכל על החשבון ולא מבין לאן הכל הלך.
            </p>
            ...
            <p className="text-white font-medium text-xl md:text-2xl leading-relaxed mt-4">
              בלי שיטה, הכסף תמיד יהיה רק &quot;תייר&quot; בחשבון הבנק שלך.
            </p>
          </div>

          <div>
            <h3 className="text-white font-bold text-2xl xs:text-3xl md:text-4xl mb-5">עיוורון פיננסי מול תלוש השכר</h3>
            <p className="text-white/60 text-xl md:text-2xl leading-relaxed">
              ברוטו, נטו, מס הכנסה, ביטוח לאומי, קרן פנסיה, קרן השתלמות —
              מישהו פעם הסביר לך מה כל אלה?
            </p>
            <p className="text-white/60 text-xl md:text-2xl leading-relaxed mt-4">
              אתה מפסיד כסף ששייך לך, רק כי אתה לא קורא את האותיות הקטנות.
              רוב האנשים לא יודעים אם הם מקבלים את מה שמגיע להם.
              הם לא יודעים אם המעסיק מפריש להם מה שצריך.
            </p>
            <p className="text-white font-medium text-xl md:text-2xl leading-relaxed mt-4">
              וזה לא סתם בורות — זה כסף אמיתי שנעלם לך כל חודש.
            </p>
          </div>
