    ...
    <section ref={ref} className="py-12 md:py-20 bg-[#080808]">
      <div className="max-w-3xl mx-auto px-5">
        ...
        <div className="grid grid-cols-2 gap-10 md:gap-20 justify-items-center mt-14">
          {[
            { name: 'דקל קאפח', role: 'מייסד שותף · פורשים כנף', bio: 'כמתכנן פיננסי (CFP) ויזם שבונה כלים טכנולוגיים לעולם הפיננסים, אני רואה כל יום איך חוסר בידע בסיסי עולה לאנשים ביוקר. אני לא מאמין בתיאוריות יבשות, אלא בפרקטיקה ובמספרים שזזים. ב׳פורשים כנף׳ אני אחראי על הפיכת המושגים המורכבים ביותר — מהשקעות ועד תלושי שכר — לשיטה ברורה שכל אחד יכול ליישם כבר מהמשכורת הקרובה, בלי לנחש ובלי לפחד.', image: null as string | null },
            { name: 'אביתר דנגור', role: 'מייסד שותף · פורשים כנף', bio: 'אחרי שנים כמורה במערכת החינוך, הבנתי שיש חור שחור בתוכנית הלימודים: אנחנו מלמדים הכל, חוץ מאת הדבר שיקבע איך החיים של הצעירים שלנו ייראו. עם תואר בכלכלה וניסיון של שנים בחינוך פורמלי ובלתי פורמלי, הקמתי את ׳פורשים כנף׳ כדי להנגיש ידע כלכלי בגובה העיניים. המטרה שלי היא פשוטה: שכל צעיר וצעירה בישראל יצאו לחיים עם הכלים שהם באמת צריכים כדי לבנות עתיד בטוח.', image: null as string | null },
          ].map((person, i) => (
            <motion.div key={i}
