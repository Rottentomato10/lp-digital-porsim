...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'פורשים כנף — להבין כסף באמת',
    description: 'להבין כסף באמת — במקום להמשיך לנחש. סדנת פיננסים מעשית לצעירים.',
    locale: 'he_IL',
    type: 'website',
    siteName: 'פורשים כנף',
  },
  twitter: {
    ...
    title: 'פורשים כנף — להבין כסף באמת',
    description: 'סדנת פיננסים מעשית לצעירים. 3 שעות. 58 שיעורים. גישה לכל החיים.',
  },
  keywords: ['סדנת פיננסים', 'חינוך פיננסי', 'השקעות', 'ניהול כסף', 'פורשים כנף', 'סדנה דיגיטלית'],
}
