...
<p style="color:rgba(255,255,255,0.65);font-size:16px;line-height:1.8;margin:0 0 14px;">אנחנו דקל ואביתר מ״פורשים כנף״. ב-5 השנים האחרונות לימדנו יותר מ-15,000 צעירים וצעירות איך כסף באמת עובד — בבתי ספר, ביחידות צבאיות, ובסדנה הדיגיטלית שלנו.</p>
...
<p style="color:rgba(255,255,255,0.5);font-size:15px;line-height:1.7;margin:0 0 14px;">ואם אתה כבר מוכן לתמונה המלאה — הסדנה שלנו מחכה לך:</p>
${CTA}`,
  },
  {
    id: 'email_2',
...
<p style="color:rgba(255,255,255,0.45);font-size:14px;margin:0 0 14px;">זה אחד מ-58 שיעורים בסדנה. בפנים מחכים גם חמשת הכוחות שקובעים שכר, טיפים למשא ומתן, ועוד הרבה.</p>
${CTA}`,
  },
  {
    id: 'email_3',
...
<p style="color:rgba(255,255,255,0.45);font-size:14px;margin:0 0 14px;">בסדנה יש שיעור שלם שמפרק תלוש שכר אמיתי סעיף סעיף — ומסביר בדיוק מה קורה עם כל שקל.</p>
${CTA}`,
  },
  {
    id: 'email_4',
...
<p style="color:rgba(255,255,255,0.65);font-size:16px;line-height:1.8;margin:0 0 14px;">בסדנה יש שיעור שלם על "מפת האוצר" — כל ההטבות, הפטורים והכסף שאתה משאיר על השולחן.</p>
${CTA}`,
  },
  {
    id: 'email_10',
...
<p style="color:rgba(255,255,255,0.45);font-size:14px;margin:0 0 14px;">בסדנה יש פרק שלם על נדל"ן — עם אזהרות מהזדמנויות שנראות טוב מדי.</p>
${CTA}`,
  },
  {
    id: 'email_12',
...
<p style="color:rgba(255,255,255,0.65);font-size:16px;line-height:1.8;margin:0 0 14px;">הסדנה שלנו היא 58 שיעורים, 3 שעות, מא׳ עד ת׳. בסופה תבין כסף יותר טוב מ-97% מהאנשים סביבך. וזה לא הבטחה — זה מה ש-15,000 תלמידים כבר חוו.</p>
...
<p style="color:rgba(255,255,255,0.65);font-size:16px;line-height:1.8;margin:0 0 14px;">{{name}}, בשבועות האחרונים שלחנו לך 12 אימיילים עם תכנים שבדרך כלל שומרים רק למי שכבר בתוך הסדנה.</p>
